  ...
  return (
    <div className="app-shell">
      <aside className="sidebar">
        <div className="logo">ArcPay</div>

        <button className={tab === "dashboard" ? "tab active" : "tab"} onClick={() => setTab("dashboard")}>
          Dashboard
        </button>

        <button className={tab === "invoices" ? "tab active" : "tab"} onClick={() => setTab("invoices")}>
          Invoices
        </button>

        <button className={tab === "payroll" ? "tab active" : "tab"} onClick={() => setTab("payroll")}>
          Payroll
        </button>

        <button className={tab === "payouts" ? "tab active" : "tab"} onClick={() => setTab("payouts")}>
          Payouts
        </button>
      </aside>
      ...
      <main className="main-view">
        <section className="glass-card hero-card">
          <div>
            <p className="eyebrow">Crypto Payments Dashboard</p>
            <h1>ArcPay_Min</h1>
          </div>
...
<div className="wallet-box">
  ...
  <div className="wallet-actions">
    ...
    <button id="btnSwitchArc">
      Switch Arc
    </button>

    <button id="btnPayMetaMask">
      Pay with MetaMask
    </button>

    <button id="btnPayCircle">
      ...
      Logout Google
        ...
        {tab === "dashboard" && (
          <section className="feature-grid">
            <div className="feature-card" onClick={() => setTab("invoices")}>
              <h2>Invoices</h2>
              <p>Create invoice, QR payment, MetaMask/Circle pay.</p>
            </div>

            <div className="feature-card" onClick={() => setTab("payroll")}>
              <h2>Payroll</h2>
              <p>Create, approve, review, execute monthly payroll.</p>
            </div>

            <div className="feature-card" onClick={() => setTab("payouts")}>
              <h2>Payouts</h2>
              <p>Track payout status, paid TX, and confirmations.</p>
            </div>

            <div className="feature-card" onClick={() => setTab("invoices")}>
              <h2>AI Draft</h2>
              <p>Generate invoice draft from text prompt.</p>
            </div>
          </section>
        )}
...
<div className="info-box">
  ...
  <div id="claimResult"></div>
            ...
            <div className="compact-form">
              <input id="title" placeholder="Invoice title" />
            ...
            <div className="info-box">
              ...
              <div id="selectedInvoice">No invoice selected.</div>
            </div>

            <div className="info-box">
              <h2>Invoice QR</h2>
              <div id="qrBox">Open an invoice to show QR.</div>
            </div>
...
if (payoutRoot) {
  createRoot(payoutRoot).render(<AppTabs />);
}